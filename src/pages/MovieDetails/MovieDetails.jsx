...
import { movie } from '../../components/Banner/delete'
...
export default function MovieDetails() {
  ...
  return (
   <div className={styles.wrapper}>
      <Breadcrumbs paths={[{name: 'Главная', path: '/'}, {name: 'Назад', path: -1},]} className={styles.breadcrumbs}/>
    <div className={styles.movieCard}>
      <div className={styles.leftBlock}>
         ...
         <div className={styles.watchabilityLogos}>
           {movie.watchability.items.map((item, index, array) => (
   ...
   <SimilarMovies genres={movie.genres}/>
   </div>
  )
  }
}
